...
const RuleEditor: React.FC<RuleEditorProps> = ({ rules, onChange, className }) => {
    ...
    const handleSaveEdit = useCallback(() => {
        ...
        onChange(rules.map((rule) => (rule.id === editingRule.id ? editingRule : rule)));
        setEditingRule(null);
                    ...
                    <div className='rule-form-body'>
                        <div className='form-group'>
                            ...
                            <select
                                value={newRule.type}
                                onChange={(e) =>
                                    setNewRule({ ...newRule, type: e.target.value as Rule['type'] })
                                }
                            >
            ...
            <div className='rules-list'>
                {rules.length === 0 ? (
                    <div className='empty-state'>
                        ...
                        <button className='btn btn-primary' onClick={handleLoadDefaults}>
                            Load Default Rules
                        </button>
                    </div>
                ) : (
                                ...
                                <>
                                    <div className='rule-content'>
                                        <div className='rule-type'>
                                            ...
                                            <span className='rule-type-label'>
